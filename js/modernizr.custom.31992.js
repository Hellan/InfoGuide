 ...
 * Build: http://modernizr.com/download/#-css_shapes
 */
;
window.Modernizr = function(a, b, c) {
	...
	function y(a, b, c) {
		var d = a.charAt(0).toUpperCase() + a.slice(1),
			e = (a + " " + cssomPrefixes.join(d + " ") + d).split(" ");
		return v(b, "string") || v(b, "undefined") ? testProps(e, b) : (e = (a + " " + domPrefixes.join(d + " ") + d).split(" "), x(e, b, c))
	}
	var d = "2.8.3",
		e = {},
		f = b.documentElement,
	...
	return e.addTest = function(a, b) {
		if (typeof a == "object")
			for (var d in a) s(a, d) && e.addTest(d, a[d]);
		else {
			a = a.toLowerCase();
			if (e[a] !== c) return e;
		...
		return e
	}, t(""), h = j = null, e._version = d, e.testAllProps = y, e
}(this, this.document), Modernizr.addTest("shapes", Modernizr.testAllProps("shapeOutside", "content-box", !0));